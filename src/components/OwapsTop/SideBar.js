...
const Sidebar = (props) => (
	<List disablePadding dense>
		...
		<ListItem
			button
			onClick={() => props.getDetails("Sensitive Data Exposure")}
		>
		...
		<ListItem
			button
			onClick={() => props.getDetails("XML External Entities (XXE)")}
		>
		...
		<ListItem
			button
			onClick={() => props.getDetails("Security Misconfiguration")}
		>
		...
		<ListItem
			button
			onClick={() => props.getDetails("Cross-Site Scripting XSS")}
		>
		...
		<ListItem
			button
			onClick={() => props.getDetails("Insecure Deserialization")}
		>
		...
		<ListItem
			button
			onClick={() =>
				props.getDetails("Using Components with Known Vulnerabilities")
			}
		>
		...
		<ListItem
			button
			onClick={() => props.getDetails("Insufficient Logging & Monitoring")}
		>
